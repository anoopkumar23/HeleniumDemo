...
public class CheckoutPage {
    ...
    private final By ADDRESS1_TEXT_BOX = By.id("address1");
    ...
    private final By CREDIT_CARD_EXPIRATION_TEXT_BOX = By.id("card-expiration");
    private final By CREDIT_CARD_CVV_TEXT_BOX = By.id("card-cvv");
    private final By CHECKOUT_BUTTON = By.xpath("//button[text()='Checkout']");
